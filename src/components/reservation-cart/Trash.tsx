...
const Trash = ({ open, close, onDelete }: TrashProps) => {
  return (
    ...
    >
      ...
      rounded-4xl justify-center items-center gap-4
      ...
      >
        ...
        />
        <span className="text-white text-[24px] font-medium">Delete room?</span>
        <div className="w-[312px] text-center">
          ...
          <p className="text-white text-[16px] font-light">
            {" "}
            You will not be able to recover them after deletion.
          </p>
        </div>
