    ...
    <Container>
      <div data-aos="fade-up" data-aos-delay="500">
        ...
        <Swiper
          ...
          loop
          className="FeedbackSlider w-full h-[250px] lg:h-[320px] xl:h-[270px] rounded-[24px] [&_.swiper-pagination-bullet]:bg-white/40 [&_.swiper-pagination-bullet]:!rounded-[7px] [&_.swiper-pagination-bullet]:duration-300 [&_.swiper-pagination-bullet-active]:!bg-white [&_.swiper-pagination-bullet-active]:!w-[30px] [&_.swiper-pagination-bullet]:!opacity-100 [&_.swiper-pagination-bullet]:w-[6px] [&_.swiper-pagination-bullet]:!h-[4px] [&_.swiper-pagination]:!bottom-0 [&_.swiper-pagination]:z-20"
        >
          {/* cart */}
              ...
              <div className="relative group">
                ...
                <div className=" inset-0 bg-white/5 border border-white/20 rounded-[24px] ">
                  ...
                  <div className="p-4 md:p-6 flex flex-col h-full">
                    ...
                    {/* Feedback Text */}
                    <p className="text-white text-sm md:text-base leading-5 md:leading-6 mb-3 md:mb-4 lg:h-[68px] lg:line-clamp-3">
                      {item?.comment}
                    </p>
