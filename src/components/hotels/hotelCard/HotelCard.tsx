...
import hotesImg from "@/public/hotel.png";
// import { Ratings } from "@/components/reusableComponent/Rating";
    ...
    >
      ...
      <div className="flex flex-col gap-4 col-span-12 lg:col-span-8">
        ...
        <div className="flex gap-3">
          {" "}
          <span>التقييم :{hotel?.rating}</span>
        ...
        <div className="flex justify-end mt-[20px] ">
          <CustomButton
            ...
            className="!bg-[#CAB16C26] !text-[#CAB16C] font-medium !w-fit !py-3"
          >
            عرض التفاصيل
          </CustomButton>
        </div>
