...
import logo from "../../../public/images/navBar/Mask group.svg"
...
const Navbar = () => {
    ...
    let logoPath =
        place === "contact-us" ? "/logo.svg" : place === "developer" ? "/logoGold.svg" : "/Legacy Logo Desktop.svg"
    ...
    return (
        <>
            <AsideMenu iconColor={"white"} lang={lang} open={open} setOpen={setOpen} />
            <div
                ...
                <Container className="!py-0">
                    <nav className="flex items-center justify-between pt-[20px] pb-[10px] lg:pt-[25px] lg:pb-[15px] lg:mx-auto ">
                        ...
                        <div className="lg:hidden relative w-[54px] h-[35px]">
                            <Image src={logo || defaultimg} alt="Logo" fill className="object-contain" />
                        </div>
