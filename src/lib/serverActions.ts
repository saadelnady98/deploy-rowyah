...
export const getProjectsData = async (slug: string, lang: string) => {
  return apiServiceCall({
    url: `project`,
    headers: { "Accept-Language": lang },
  });
};
export const getSingleProjectData = async (slug: string, lang: string) => {
  return apiServiceCall({
    url: `project/${slug}`,
    headers: { "Accept-Language": lang },
  });
...
export const getCategoryData = async (slug: string, lang: string) => {
  return apiServiceCall({
    url: `categoryblog/${slug}`,
    headers: { "Accept-Language": lang },
  });
};
...
export const getTerms = async (lang: string) => {
    return apiServiceCall({ url: `terms`, headers: { "Accept-Language": lang } })
}

export const getPrivacy = async (lang: string) => {
    return apiServiceCall({ url: `privacy`, headers: { "Accept-Language": lang } })
}
...
export const getFaqs = async (lang: string) => {
    return apiServiceCall({ url: "faq", headers: { "Accept-Language": lang } })
}
