...
import errorImage from "@/public/assets/errorAndNotFound/404 Error Page not Found with people connecting a plug-bro 1.svg";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center ">
      <div className="text-center ">
        <ErrorComponent
          title={locale === "ar" ? " حدث خطأ غير متوقع " : " An unexpected error occurred. "}
          des={
            locale === "ar"
              ? " واجهنا مشكلة أثناء معالجة طلبك. نحن نعمل على إصلاحها بأسرع وقت. حاول مرة أخرى لاحقًا."
